...
<div class="row top-buttons">
    <div class="col-md-4">
        <a class="btn btn-primary" href="{{ route('socios.create') }}" ><i class="fas fa-user-plus"></i> Adicionar Sócio</a>
    </div>
    <div class="col-md-4">
        <button  class="btn btn-success" type="button" data-toggle="modal" data-target="#gerir-quotas"><i class="fas fa-euro-sign"></i> Gerir Quotas</button>
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu">
                <form  method="GET" action="{{action('SocioController@index')}}" id="pesquisarSocio">
                    ...
                    @endcan
                    <div class="form-group">
                        {{ Form::select('ordenar', [null => 'Ordenar Por'] +  array('IDA' => 'Nº Sócio Ascendente', 'IDD' => 'Nº Sócio Descendente', 'NA' => 'Nome Ascendente', 'ND' => 'Nome Descendente'), null, ['id' => 'idOrdenar', 'class' => 'form-control', 'name' => 'ordenar'])}}
                    </div>
                    <div class="col-auto">
