...
<div class="form-group">
    ...
    <input
        ...
        placeholder="aaaa-mm-dd hh:mm:ss" value="@if(isset($movimento)){{ old('hora_descolagem', date('H:i',strtotime($movimento->hora_descolagem))) }}@else{{ date('H:i',strtotime(old('hora_descolagem'))) }}@endif" />
...
<div class="form-group">
    ...
    <input
        ...
        placeholder="aaaa-mm-dd hh:mm:ss" value="@if(isset($movimento)){{ old('hora_aterragem', date('H:i',strtotime($movimento->hora_aterragem))) }}@else{{  date('H:i',strtotime(old('hora_aterragem')))  }}@endif" />
