...
<div class="container">
    <div class="row">
        ...
        <div class="col">
            ...
            {{ $movimentosConflitos->appends(request()->except('movimentosConflitos'))->links() }}
        </div>
        @endif
        ...
        <div class="col">
            ...
            {{ $movimentosConfirmar->appends(request()->except('movimentosConfirmar'))->links() }}
        </div>
        @endif
    </div>
    <div class="row">
        ...
        <div class="col">
            ...
            {{ $licencasConfirmar->appends(request()->except('licencasConfirmar'))->links() }}
        </div>
        @endif
        ...
        <div class="col">
            ...
            {{ $certificadosConfirmar->appends(request()->except('certificadosConfirmar'))->links() }}
        </div>
        @endif
    </div>
    <div class="row">
        ...
        <div class="col">
            ...
            {{ $licencasValidade->appends(request()->except('licencasValidade'))->links() }}
        </div>
        @endif
        ...
        <div class="col">
            ...
            {{ $certificadosValidade->appends(request()->except('certificadosValidade'))->links() }}
        </div>
        @endif
    </div>
</div>
